...
namespace Linq40
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var consult1 =
                from p1 in list
                where p1.Category.Tier == 1 && p1.Price < 900.00
                select p1;
            ...
            var consult3 = 
                from p3 in list
                where p3.Name[0] == 'C'
                select new {p3.Name, p3.Price, CategoryName = p3.Category.Name};
            ...
            var consult7 = 
                (from p7 in list
                where p7.Price > 3000.0
                select p7).FirstOrDefault();
